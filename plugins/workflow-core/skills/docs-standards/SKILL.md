...
| PR/MR 설명           | 무엇이 달라지는지, 어떻게 적용하는지, what, how, why 순서로               | what, how, why         |          |
...
- 긴 호흡의 문장으로 이루어지는 why는 PR/MR의 설명 마지막 별도 섹션에 모은다. 문서나 코드에서 근거가 필요하면 PR/MR, 이슈, 또는 decisions 문서 링크를 붙인다.
